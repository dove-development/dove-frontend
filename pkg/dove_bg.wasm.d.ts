...
export function stabilityupdatemaxdeposit_getData(a: number, b: number): void;
export function stabilityupdatemaxdeposit_getAccounts(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
...
export function vaultbuycollateral_getAccounts(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
...
export function vaultfailauction_getAccounts(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
export function vaultliquidate_getData(a: number): void;
export function vaultliquidate_getAccounts(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number): void;
...
export function vaultunliquidate_getAccounts(a: number, b: number, c: number): void;
...
export function worldcreate_getData(a: number, b: number, c: number, d: number): void;
...
export function auctionconfig_new(a: number, b: number, c: number, d: number): void;
...
export function bookconfig_new(a: number, b: number): number;
export function bookconfig_interestRate(a: number): number;
export function bookconfig_rewardSchedule(a: number): number;
...
export function book_projectRewards(a: number, b: number, c: number): number;
...
export function interestrate_new(a: number, b: number): void;
export function interestrate_apy(a: number): number;
export function interestrate_zero(): number;
export function page_projectTotal(a: number, b: number, c: number, d: number): number;
export function page_projectRewards(a: number, b: number, c: number, d: number): number;
export function schedule_new(a: number, b: number, c: number, d: number): void;
export function schedule_at(a: number, b: number): number;
export function schedule_totalEmission(a: number): number;
...
export function config_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number): void;
export function config_dvdInterestRate(a: number): number;
...
export function __wbg_dvdprice_free(a: number, b: number): void;
export function dvdprice_projectPrice(a: number, b: number, c: number): number;
...
export function offeringconfig_doveOfferingSize(a: number): number;
export function offering_amount(a: number): number;
export function offering_getPrice(a: number, b: number, c: number): number;
export function offering_isActive(a: number): number;
export function offering_getSecsElapsed(a: number, b: number): number;
export function offering_getFailPrice(a: number, b: number): number;
export function offering_isDvd(a: number): number;
...
export function vesting_getEmissionDue(a: number, b: number): number;
export function vesting_creationTime(a: number): number;
export function vesting_distributed(a: number): number;
...
export function collateral_maxDeposit(a: number): number;
...
export function stability_mintKey(a: number, b: number): void;
...
export function vault_isLiquidated(a: number): number;
export function vault_calculateAuctionPrice(a: number, b: number, c: number, d: number, e: number): void;
export function vault_getAuctionSecsElapsed(a: number, b: number, c: number): void;
export function vault_isAuctionOver(a: number, b: number, c: number): number;
export function vault_getAuctionFailPrice(a: number, b: number, c: number, d: number): void;
...
export function __wbg_get_world_stable_dvd(a: number): number;
export function __wbg_set_world_stable_dvd(a: number, b: number): void;
export function __wbg_get_world_dvd_price(a: number): number;
export function __wbg_set_world_dvd_price(a: number, b: number): void;
...
export function world_dvdPrice(a: number): number;
export function world_stableDvd(a: number): number;
export function world_flashMint(a: number): number;
...
export function schedule_warmupLength(a: number): number;
export function schedule_totalLength(a: number): number;
export function config_maxLtv(a: number): number;
export function flashmintconfig_fee(a: number): number;
export function flashmintconfig_limit(a: number): number;
export function offeringconfig_surplusLimit(a: number): number;
export function offeringconfig_deficitLimit(a: number): number;
export function offeringconfig_dvdOfferingSize(a: number): number;
export function stabledvd_circulating(a: number): number;
export function stability_deposited(a: number): number;
export function stability_maxDeposit(a: number): number;
...
export function __wbg_stabilityupdatemaxdeposit_free(a: number, b: number): void;
...
export function __wbg_interestrate_free(a: number, b: number): void;
...
export function __wbg_stabledvd_free(a: number, b: number): void;
